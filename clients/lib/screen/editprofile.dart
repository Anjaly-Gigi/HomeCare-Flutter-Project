...
class _EditproState extends State<Editpro> {
  ...
  String? clientId; // Store the logged-in client's ID
  ...
  void fetchData() async {
    ...
    try {
      ...
      if (response != null) {
        setState(() {
          _nameController.text = response['client_name'];
          _addressController.text = response['client-address'];
          _phoneController.text = response['client_contact'];
        });
      } else {
